...
SFT_MODEL_PATH="/mnt/nfs3/caozhe/workspace/SimpleVLA-RL/ckpts/SimpleVLA-RL/maniskill_4_159/actor/global_step_2"
CKPT_PATH="./ckpts"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=1,3,5,7 python -m verl.trainer.main_ppo \
    ...
    trainer.wandb_kwargs.id=xj7lstuw    \
