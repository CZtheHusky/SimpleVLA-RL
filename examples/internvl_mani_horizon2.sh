...
EXPERIMENT_NAME='maniskill_2in1' 
...
SFT_MODEL_PATH="/mnt/nfs3/caozhe/workspace/SimpleVLA-RL/vlav-project/maniskill_stack_cubes_dual_horizon_2/internvl2-2b/v0-20250804-230001/checkpoint-640"
CKPT_PATH="./ckpts"
...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m verl.trainer.main_ppo \
    ...
    data.max_prompt_length=670 \
    data.max_response_length=30 \
    actor_rollout_ref.actor.strategy=dp \
    critic.strategy=dp  \
    reward_model.strategy=dp \
    actor_rollout_ref.model.path=$SFT_MODEL_PATH \
    actor_rollout_ref.model.vla=$VLA_NAME \
    actor_rollout_ref.model.action_token_len=30 \
    ...
    actor_rollout_ref.rollout.val_micro_batch_size=15 \
    actor_rollout_ref.rollout.temperature=0.3 \
    actor_rollout_ref.rollout.horizon=2 \
    ...
    actor_rollout_ref.rollout.max_prompt_length=670 \
